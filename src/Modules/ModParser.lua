...
local modNameList = {
	...
	["restoration of runic ward"] = "WardRechargeFaster",
	["armour"] = "Armour",
	["evasion"] = "Evasion",
...
local specialModList = {
	...
	["(%d+)%% of damage taken bypasses runic ward"] = function(num) return { mod("WardBypass", "BASE", num) } end,
	["(%d+)%% increased ward regeneration"] = function(num) return { mod("WardRegen", "INC", num) } end,
	["(%d+)%% increased runic ward regeneration"] = function(num) return { mod("WardRegen", "INC", num) } end,
	-- Runic Ward - new stat IDs
	["base_maximum_ward"] = mod("Ward", "BASE"),
	["maximum_ward_+%"] = mod("Ward", "INC"),
	["base_ward_regeneration_per_minute"] = mod("WardRegen", "BASE"),
	["base_ward_regeneration_per_minute_+%"] = mod("WardRegen", "INC"),
	["base_ward_cost_efficiency"] = mod("WardCostEfficiency", "BASE"),
	["base_ward_cost_efficiency_+%"] = mod("WardCostEfficiency", "INC"),
	["total_base_ward_cost"] = mod("WardCost", "BASE"),
	["base_ward_cost_%"] = mod("WardCostPercent", "BASE"),
	["recover_x_ward_on_block"] = mod("WardRecoverOnBlock", "BASE"),
	["recover_x_ward_on_charm_use"] = mod("WardRecoverOnCharmUse", "BASE"),
	["excess_ward_regeneration_is_applied_to_mana"] = flag("ExcessWardToMana"),
	["regenerate_ward_instead_of_life"] = flag("WardRegenInsteadOfLife"),
	...
	["recover_x%_of_maximum_ward_on_persistent_minion_death"] = mod("WardCoverOnMinionDeath", "BASE"),
	["recover (%d+)%% of maximum ward on persistent minion death"] = function(num) return { mod("WardCoverOnMinionDeath", "BASE", num) } end,
